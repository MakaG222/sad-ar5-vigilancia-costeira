...
| Problema | Acção |
|----------|-------|
| Porta ocupada | `./stop-mac.sh` e voltar a arrancar |
| API lenta no 1.º arranque | Esperar até 90 s; ver `.run/api.log` |
