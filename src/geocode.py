"""
geocode.py — Geocodificação aproximada de distritos/concelhos (lat, lon).

Usado pela camada de apreensões marítimas. Tokens não mapeados devolvem None.
"""
...
def geocode(token: str) -> tuple[float, float] | None:
